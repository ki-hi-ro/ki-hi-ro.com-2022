...
<script>
  $(document).ready(function() {
      ...
      $.each(categories, function(category, tags) {
          ...
          let header = $('<div class="accordion-header"><span class="arrow">＋</span>' + category + '</div>');
          let content = $('<div class="accordion-content"></div>');
