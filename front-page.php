...
<div class="mv">
    <img class="pc-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/top/mv-pc.png?20220804"
        alt="PCのメインビジュアル">
    <img class="sp-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/top/mv-sp.png?20220804"
        alt="スマホのメインビジュアル">
    <a href="<?php echo home_url('#contact'); ?>" class="contact-btn">
        <img class="sp-img" src="<?php echo get_template_directory_uri(); ?>/assets/img/top/contact-btn.png?20220806"
            alt="お問い合わせボタン">
    </a>
...
<main class="container">
    ...
    <section class="top-section" id="what-i-did">
        ...
        <div class="more-link --top-sec">
          <a href="<?php echo home_url('category/what-i-did'); ?>">これまでの対応内容一覧<img src="<?php echo get_template_directory_uri(); ?>/assets/img/top/arrow-right.svg" /></a>
        </div>
    </section>
