...
<main class="container">
    ...
    <!-- 学習 -->
    <ul class="blog-tab">
      <li class="blog-tab-content--study blog-tab__skill" contentId="skill-blog--study">技術ブログ</li>
      <li class="blog-tab-content--study blog-tab__study current-tab" contentId="study-blog--study">学習ブログ</li>
