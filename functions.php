...
require_once get_template_directory() . '/functions/random-quote.php';
require_once get_template_directory() . '/functions/random-image.php';
require_once get_template_directory() . '/functions/random-tags.php';
